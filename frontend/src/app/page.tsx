          ...
          {activeTab === 'gatherers' ? (
            <>
              ...
              <div className="bg-[#000000] p-8 rounded-lg border border-[#49c5b6] space-y-4">
                ...
                <h2 className="text-2xl font-bold">Gatherers: FAFO Origins</h2>
                <p className="text-gray-400">
                  Embark on a unique journey with Gatherers - a collection of
                  generative NFTs where each piece represents a distinctive
                  character in a vast digital landscape. Every Gatherer is
                  algorithmically generated with its own set of traits and
                  characteristics.
                </p>
              </div>
            </>
            ...
            <>
              ...
              <div className="bg-[#000000] p-8 rounded-lg border border-[#49c5b6] space-y-4">
                ...
                <p className="text-gray-400">
                  Join the Temporal ASCII Portraits collection - where each NFT
                  is a unique ASCII art portrait that evolves over time based on
                  blockchain progression. Your portrait will subtly change every
                  100 blocks, creating a dynamic piece of on-chain art.
                </p>
              </div>
            </>
          )}
